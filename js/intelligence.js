...
// === Intelligence page entry control ===
(() => {
  ...
  let skillValues = JSON.parse(localStorage.getItem("skillValues"));
  ...
  const correctIQAnswers = {
    q9:"A",q10:"C",q11:"B",q12:"C",q13:"C",
    q14:"B",q15:"D",q16:"B",q17:"C",q18:"D"
  };
  ...
  while (currentIndex < questions.length && answers[questions[currentIndex]?.id]) {
    currentIndex++;
  }
  ...
  function showResults() {
    ...
    let iqCorrect = 0;
    iqIDs.forEach(qid => {
      if (answers[qid]?.toUpperCase() === correctIQAnswers[qid]) iqCorrect++;
    });

    const userSkill = skillValues.Intelligence;
    const diff = iqCorrect - userSkill;
  ...
  additionalPoints = 0;
  newIntelligence = userSkill; // no change
}
